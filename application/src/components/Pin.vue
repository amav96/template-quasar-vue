<template>
    ...
    <svg   :height="`${scale}px`" :width="`${scale}px`" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	 viewBox="0 0 293.334 293.334" xml:space="preserve">
        <g>
            <g>
                <path :style="`fill:${color}`" d="M146.667,0C94.903,0,52.946,41.957,52.946,93.721c0,22.322,7.849,42.789,20.891,58.878
                ...
                <circle :style="`fill:#f7f9fc`" cx="146.667" cy="90.196" r="68"/>
            </g>
        </g>
</svg>
</template>
